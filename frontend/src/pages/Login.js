...
const Login = ({ onNavigate }) => {
  ...
  const handleLogin = async (e) => {
    ...
    setTimeout(() => {
      ...
      if (email === 'demo@indusign.com' && password === 'password123') {
        // Successful login
        ...
        setLoginError('Invalid email or password. Try demo@indusign.com / password123');
      }
    }, 1500);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Email: <span className="font-mono">demo@indusign.com</span><br />
        ...
        <div className="text-center text-xs text-gray-500">
          <p>© 2024 InduSign. All rights reserved.</p>
